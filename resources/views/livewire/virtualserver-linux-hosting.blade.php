...
@section('content')
            ...
            <div class="main-content app-content">
                <section class="banner-section banner-1">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-7">
                                <div class="">
                                    <p class="mb-3 content-1 h5 text-white">Linux KVM <span class="tx-info-dark">VPS Hosting</span></p>
                                    ...
                                    <p class="mb-4 tx-16">Start your business at just<span class="h2 text-white"> $13.8</span><span class="op-5 tx-14"> / month</span></p>
                                </div>
                                <a href="#plans" class="btn btn-lg btn-secondary mb-2 mb-sm-0"><i class="fe fe-arrow-right me-2"></i> Get Started</a>
                                <a href="https://themeforest.net/user/spruko/portfolio" target="_blank" class="btn btn-lg btn-white mb-2 mb-sm-0"><i class="fe fe-shopping-cart me-2"></i> Buynow</a>
                            </div>
                            <div class="col-lg-5">
                ...
                <section class="section">
                    <img src="{{asset('build/assets/images/patterns/22.png')}}" alt="img" class="patterns-6 op-4 z-index-0 dark-opacity1">
                    <img src="{{asset('build/assets/images/patterns/24.png')}}" alt="img" class="patterns-2 op-1 z-index-0">
                    <img src="{{asset('build/assets/images/patterns/9.png')}}" alt="img" class="patterns-1 filter-invert op-1 z-index-0">
                    <div class="container">
                        <div class="heading-section">
                        ...
                        <div class="row align-items-center">
                                    ...
                                    <li class="list-item mb-4">
                                        <div class="d-flex align-items-start">
                                            <div class="me-4 d-inline-block p-3 bg-primary br-7">
                                                <img src="{{asset('build/assets/images/png/33.png')}}" alt="img">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h4 class="mb-2">cPanel / WHM</h4>
                                                <p class="mb-0">Dolores sed no dolor invidunt diam sed sanctus. Amet erat justo aliquyam voluptua erat aliquyam. Duo sed sadipscing et gubergren rebum accusam invidunt at, kasd.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-item mb-4">
                                        <div class="d-flex align-items-start">
                                            <div class="me-4 d-inline-block p-3 bg-secondary br-7">
                                                <img src="{{asset('build/assets/images/png/32.png')}}" alt="img">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h4 class="mb-2">Plesk</h4>
                                                <p class="mb-0">Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil unde omnis iste natus error vitae dicta sunt explicabo.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-item">
                                        <div class="d-flex align-items-start">
                                            <div class="me-4 d-inline-block p-3 bg-success br-7">
                                                <img src="{{asset('build/assets/images/png/34.png')}}" alt="img">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h4 class="mb-2">WHMCS</h4>
                                                <p class="mb-0">Quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut, accusamus et iusto odio dignissimos ducimus.</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="col-lg-6 text-center mt-5 mt-lg-0">
                                <img src="{{asset('build/assets/images/png/13.png')}}" class="img-fluid" alt="img">
                            </div>
                        </div>
                    </div>
                </section>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive border br-7">
                                            <table class="table table-bordered pricing-table mb-0 table-hover border-hidden">
                                                            ...
                                                            <div class="text-start">
                                                                ...
                                                                <div class="d-lg-flex align-items-center justify-content-between">
                                                                    <div class="form-check form-switch form-switch-lg mb-0">
                                                                        <input class="form-check-input" type="checkbox" role="switch" id="switchHdd-month">
                                                                        <label class="form-check-label" for="switchHdd-month">Switch to HDD</label>
                                                                    </div>
                                                                    <a href="{{url('dedicated-server')}}" class="plain-link">Learn more</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <th>
                                                            ...
                                                            <p class="h2 mb-0 tx-28">$9<span class="tx-13 tx-muted op-7 ms-1">/ month</span></p>
                                                        </th>
                                                        <th>
                                                            ...
                                                            <p class="h2 mb-0 tx-28">$15<span class="tx-13 tx-muted op-7 ms-1">/ month</span></p>
                                                        </th>
                                                        <th>
                                                            ...
                                                            <p class="h2 mb-0 tx-28">$29<span class="tx-13 tx-muted op-7 ms-1">/ month</span></p>
                                                        </th>
                                                        <th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pricing-feature">Cores</td>
                                                        <td>2 Cores</td>
                                                        <td>2 Cores</td>
                                                        <td>3 Cores</td>
                                                        <td>4 Cores</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="main-feature">20 GB SSD</td>
                                                        <td class="main-feature">40 GB SSD</td>
                                                        <td class="main-feature">80 GB SSD</td>
                                                    ...
                                                    <tr>
                                                        <td class="pricing-feature">Dedicated IPs</td>
                                                        <td>0 Additional IP</td>
                                                        <td>1 Additional IP</td>
                                                        <td>1 Additional IP</td>
                                                        <td>1 Additional IP</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th class="">
                                                            <div class="text-start">
                                                                ...
                                                                <div class="d-lg-flex align-items-center justify-content-between">
                                                                    <div class="form-check form-switch form-switch-lg mb-0">
                                                                        <input class="form-check-input" type="checkbox" role="switch" id="switchHdd-year">
                                                                        <label class="form-check-label" for="switchHdd-year">Switch to HDD</label>
                                                                    </div>
                                                                    <a href="{{url('dedicated-server')}}" class="plain-link">Learn more</a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <th>
                                                            <span class="avatar rounded-circle bg-primary-transparent tx-primary mb-3"><i class="bi bi-activity"></i></span>
                                                            <p class="h5 mb-2">V1 - SSD</p>
                                                            <p class="h2 mb-0 tx-28">$19<span class="tx-13 tx-muted op-7 ms-1">/ year</span></p>
                                                        </th>
                                                        <th>
                                                            <span class="avatar rounded-circle bg-primary-transparent tx-primary mb-3"><i class="bi bi-box-seam"></i></span>
                                                            <p class="h5 mb-2">V2 - SSD</p>
                                                            <p class="h2 mb-0 tx-28">$115<span class="tx-13 tx-muted op-7 ms-1">/ year</span></p>
                                                        </th>
                                                        <th>
                                                            <span class="avatar rounded-circle bg-primary-transparent tx-primary mb-3"><i class="bi bi-airplane"></i></span>
                                                            <p class="h5 mb-2">V3 - SSD</p>
                                                            <p class="h2 mb-0 tx-28">$129<span class="tx-13 tx-muted op-7 ms-1">/ year</span></p>
                                                        </th>
                                                        <th>
                                                            <span class="avatar rounded-circle bg-primary-transparent tx-primary mb-3"><i class="bi bi-gem"></i></span>
                                                            <p class="h5 mb-2">V4 - SSD</p>
                ...
                <section class="section custom-bg">
                    <img src="{{asset('build/assets/images/patterns/9.png')}}" alt="img" class="patterns-9 filter-invert op-1 z-index-0">
                    <img src="{{asset('build/assets/images/patterns/24.png')}}" alt="img" class="patterns-3 op-1 z-index-0">
                    <img src="{{asset('build/assets/images/patterns/26.png')}}" alt="img" class="patterns-1 filter-invert op-1">
                    <div class="container">
                        <div class="row justify-content-between mb-3">
                            <div class="col-lg-5">
                                <div class="heading-section text-start">
                                    <div class="heading-title">Additional <span class="tx-primary">Storage</span></div>
                                    <div class="heading-description">Gubergren sit et gubergren kasd sanctus diam dolore, lorem dolore</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <p class="mb-1 tx-18 fw-500">Get High Performance Storage Volumes for your VPS</p>
                                <p class="tx-28 fw-600 tx-primary mb-0">$12.00<span class="tx-14"> / GB / Month</span></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="text-center">
                                    <img src="{{asset('build/assets/images/png/28.png')}}" class="img-fluid" alt="img" width="420">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section bg-gray-100 bg-pattern-1">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Services</span></div>
                            <div class="heading-title">Manage <span class="tx-primary">Hosting</span></div>
                            <div class="heading-description">VPS Linux Hosting Services</div>
                        </div>
                        <div class="row align-items-center justify-content-center">
                            <div class="col-md-5">
                                <div class="card bordeprimary feature-card-7 feature-card-7-primary mb-5 text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0">You can Start, Stop, Restart, Rebuild your VPS from the Server Management Panel. Sit et sit amet sanctus sit sanctus.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="card feature-card-7 feature-card-7-secondary mb-5 text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0">With full root access, you get complete control to manage your server resources. Sit et sit amet sanctus sit sanctus, tempor justo.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="card feature-card-7 feature-card-7-success mb-5 text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0">VNC allows you quick access to your VPS for easy management. Sit et sit amet sanctus sit sanctus, tempor justo duo rebum ipsum.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="card feature-card-7 feature-card-7-danger mb-5 text-center">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mb-3">WHMCS</h4>
                                        <p class="mb-0">Optionally, you can install & integrate WHMCS with your VPS Server seamlessly. Sit et sit amet sanctus sit sanctus, tempor.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="section">
                    <img src="{{asset('build/assets/images/patterns/26.png')}}" alt="img" class="patterns-1 filter-invert op-1 z-index-0">
                    <img src="{{asset('build/assets/images/patterns/22.png')}}" alt="img" class="patterns-8 sub-pattern-1 op-6 z-index-0 dark-opacity1">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-6 text-center mb-5 mb-lg-0 my-auto">
                                <img src="{{asset('build/assets/images/png/19.png')}}" class="img-fluid" alt="img" width="350">
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-2 col-sm-6">
                                <div class="card feature-card-15">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/7.png')}}" alt="img" height="40" class="img-fluid tool-img">
                                        <img src="{{asset('build/assets/images/png/apps/19.png')}}" alt="img" height="40" class="img-fluid tool-img-white">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6">
                                <div class="card feature-card-15">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/8.png')}}" alt="img" height="40" class="img-fluid tool-img">
                                        <img src="{{asset('build/assets/images/png/apps/20.png')}}" alt="img" height="40" class="img-fluid tool-img-white">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6">
                                <div class="card feature-card-15">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/9.png')}}" alt="img" height="40" class="img-fluid tool-img">
                                        <img src="{{asset('build/assets/images/png/apps/21.png')}}" alt="img" height="40" class="img-fluid tool-img-white">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6">
                                <div class="card feature-card-15">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/10.png')}}" alt="img" height="40" class="img-fluid tool-img">
                                        <img src="{{asset('build/assets/images/png/apps/22.png')}}" alt="img" height="40" class="img-fluid tool-img-white">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5 col-sm-12">
                                ...
                                <a href="{{url('contact-us')}}" class="btn btn-secondary btn-lg mb-4">Contact Now</a>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <a href="{{url('acronis-backup')}}" class="plain-link">Learn More</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
