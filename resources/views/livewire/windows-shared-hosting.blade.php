                    ...
                    <div class="banner-2 banner-section banner-arrow-down">
                        ...
                        <div class="container">
                            <div class="row align-items-stretch">
                                <div class="col-lg-7">
                                    <div class="mb-4">
                                        <p class="mb-3 content-1 h5 text-white">Windows Shared Hosting - At It's <span class="tx-info-dark">Simplest Best</span></p>
                                    ...
                                    <div class="card-body">
                                        <div class="p-2 rounded-circle bg-primary-transparent d-inline-block mb-4">
                                            <span class="avatar avatar-lg feature-avatar all-ease-03 rounded-circle bg-primary-gradient text-white tx-24">
                                                <i class="bi bi-gear outline"></i>
                                                <i class="bi bi-gear-fill filled"></i>
                                            </span>
                                        </div>
                                        <h4 class="mb-3">Plex for Management</h4>
                                        <p class="mb-0">Parallels Plesk, a powerful control panel, lets you manage your hosting package including the files, applications easily!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                ...
                <section class="section bg-pattern-2 bg-image1">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card feature-card-2 reveal active">
                                    <div class="card-body text-center p-4">
                                        <div class="mb-3">
                                        ...
                                        <p class="mb-0">Sed eos kasd ea dolore justo et, diam amet clita stet dolor, sit consetetur clita sanctus dolor, ea amet diam. Clita consetetur sanctus.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card feature-card-2 reveal">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="mb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti diam amet clita.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul class="list-unstyled fw-500 mb-4">
                                    <li class="list-item mb-2">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <span class="flex-grow-1 fw-500">50+ Plugins</span>
                                        </div>
                                    </li>
                                    <li class="list-item mb-2">
                                        <div class="d-flex align-items-start">
                                            <span class="me-2 tx-primary"><i class="bi bi-check-circle-fill"></i></span>
                                            <span class="flex-grow-1 fw-500">Solid State Drivers (SSD)</span>
                                        </div>
                                    </li>
                                    <li class="list-item mb-2">
                                        <div class="d-flex align-items-start">
                                            <span class="me-2 tx-primary"><i class="bi bi-check-circle-fill"></i></span>
                                            <span class="flex-grow-1 fw-500">Light Speed Web Server</span>
                                        </div>
                                    </li>
                                    <li class="list-item">
                                        <div class="d-flex align-items-start">
                                            <span class="me-2 tx-primary"><i class="bi bi-check-circle-fill"></i></span>
                                            <span class="flex-grow-1 fw-500">Ultimate Web Space</span>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <div class="feature-card-5 feature-card-5-primary hover position-relative">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center mb-5 bg-light br-5">
                                                <img src="{{asset('build/assets/images/png/17.png')}}" alt="img" width="220" class="img-fluid">
                                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="feature-card-5 feature-card-5-primary hover position-relative">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center mb-5 bg-light br-5">
                                                <img src="{{asset('build/assets/images/png/19.png')}}" alt="img" width="220" class="img-fluid">
                                            </div>
                                            ...
                                            <ul class="list-unstyled tx-14 mb-0">
                                                ...
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Customizable Error Page</span>
                                                    </div>
                                                </li>
                                                <li class="list-item">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Advanced Website Statistics</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="feature-card-5 feature-card-5-primary hover position-relative">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center mb-5 bg-light br-5">
                                                <img src="{{asset('build/assets/images/png/18.png')}}" alt="img" width="220" class="img-fluid">
                                            </div>
                                            ...
                                            <ul class="list-unstyled tx-14 mb-0">
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Windows Server 2008</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">IIS 7.0, ASP.NET 4.5, ASP, PHP 5.2.x to 7.1.x, GD, cURL, CGI, mcrypt</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">MySQL 5, MSSQL 2012</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                        ...
                        <div class="accordion accordion-style-1" id="acc-style-1">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="acc-8" class="accordion-collapse collapse" data-bs-parent="#acc-style-1">
                                    <div class="accordion-body">While a Shared Hosting package cannot be used for this purpose, you can easily resell custom packages with our Reseller Hosting. To view our Reseller Hosting plans, <a href="{{url('windows-reseller-hosting')}}" class="plain-link">click here</a>.</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
