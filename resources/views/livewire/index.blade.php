                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5">
                                <div class="text-lg-end text-center mt-4 mt-lg-0">
                                    <img src="{{asset('build/assets/images/png/1.png')}}" class="img-fluid" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card mb-lg-0">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <h5><a href="{{url('blog-details')}}" class="tx-color-default"> Cloud Hosting growing faster </a></h5>
