...
@section('content')
            ...
            <div class="main-content app-content">
                <section class="banner-section section banner-1">
                    ...
                    <img src="{{asset('build/assets/images/patterns/10.png')}}" alt="img" class="patterns-8 op-2">
                    <div class="container">
                        <div class="swiper homeSwiper">
                            <div class="swiper-wrapper">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="mb-4">
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li class="list-item mb-3"><i class="fe fe-chevron-right bg-white-2 rounded-circle p-1 me-2"></i>Money Back Guarantee</li>
                                                </ul>
                                                <h2 class="text-white">Coupon Code : <span class="tx-warning">HTMSUNSHINE</span></h2>
                                            </div>
                                            <a href="{{url('linux-shared-hosting')}}" class="btn btn-secondary me-2"><i class="fe fe-eye me-2"></i> View Plans</a>
                                            <a href="https://themeforest.net/user/spruko/portfolio" target="_blank" class="btn btn-white"><i class="fe fe-shopping-cart me-2"></i> Buynow</a>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="text-center mt-5 mt-md-0">
                                                <img src="{{asset('build/assets/images/png/47.png')}}" class="img-fluid" alt="img" width="430">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">                                
                                    <div class="row align-items-stretch">
                                        <div class="col-lg-6">
                                            ...
                                            <a href="{{url('windows-shared-hosting')}}" class="btn btn-secondary me-2"><i class="fe fe-eye me-2"></i> View Plans</a>
                                            <a href="https://themeforest.net/user/spruko/portfolio" target="_blank" class="btn btn-white"><i class="fe fe-shopping-cart me-2"></i> Buynow</a>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="banner-bg mt-4 mt-md-0">
                                                <img src="{{asset('build/assets/images/png/50.png')}}" class="img-fluid" alt="img" width="430">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">                                
                                    <div class="row align-items-center">
                                        <div class="col-lg-7">
                                            <h1 class="content-1 text-white">20% Off on Domains</h1>
                                            ...
                                            <div class="row align-items-center my-4">
                                                <div class="col-xxl-8 col-sm-7 mb-3 mb-sm-0">
                                                    <form action="javascript:void(0);" class="form">
                                                        <div class="form-group custom-form-group">
                                                            <input type="search" class="form-control form-control-lg" placeholder="Find your domain name...">
                                                            <button class="custom-form-btn btn btn-primary border-0" type="button">Search</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="col-xxl-4 col-sm-5 mb-3 mb-sm-0 mt-5 mt-md-0">
                                                    <span class="me-3 exchange-icon"><i class="bi bi-arrow-left-right"></i></span>
                                                    <a href="{{url('domain-transfer')}}" class="custom-form-btn btn btn-secondary">Transfer</a>
                                                </div>
                                            </div>
                                            <div class="d-sm-flex d-none mb-4">
                                ...
                                <div class="swiper-slide">                                
                                    <div class="row align-items-center">
                                        <div class="col-lg-7">
                                            <div class="mb-4">
                                                <h1 class="content-1 text-white">40% Off on VPS Hosting</h1>
                                            ...
                                            <a href="{{url('virtualserver-linux-hosting')}}" class="btn btn-secondary me-2"><i class="fe fe-eye me-2"></i> View Plans</a>
                                            <a href="https://themeforest.net/user/spruko/portfolio" target="_blank" class="btn btn-white"><i class="fe fe-shopping-cart me-2"></i> Buynow</a>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="text-lg-end text-center mt-4 mt-lg-0">
                                                <img src="{{asset('build/assets/images/png/15.png')}}" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">                                
                                    <div class="row align-items-center">
                                        <div class="col-lg-6">
                                            <div class="mb-4">
                                                <h1 class="content-1 text-white">60% Off on Cloud Hosting</h1>
                                                <p class="mb-4 content-2 tx-18">Get Your Business Online In An Affordable Way</p>
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li class="list-item"><i class="fe fe-chevron-right bg-white-2 rounded-circle p-1 me-2"></i>Simplified Prepaid Billing</li>
                                                </ul>
                                                <h2 class="text-white">Coupon Code : <span class="tx-warning">HTMSUNSHINE</span></h2>
                                            </div>
                                            <a href="{{url('professional-cloud')}}" class="btn btn-secondary me-2"><i class="fe fe-eye me-2"></i> View Plans</a>
                                            <a href="https://themeforest.net/user/spruko/portfolio" target="_blank" class="btn btn-white"><i class="fe fe-shopping-cart me-2"></i> Buynow</a>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="banner-bg acronis-image mt-5 mt-md-0">
                                                <img src="{{asset('build/assets/images/png/55.png')}}" class="reseller-img img-fluid" alt="img" width="350">
                                            </div>
                                        </div>
                                    </div>
                                </div>                            
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-8">
                                            <div class="mb-4">
                                                ...
                                                <h1 class="content-1 text-white">10% Off on <span class="tx-info-dark">SSL Certificate</span> </h1>
                                                <p class="">All SSL Certificates provide the baseline encryption needed to keep
                                                    your data &amp; your customers safe. Beyond encryption, choose the SSL solution that
                                                    aligns best with your company goals &amp; needs.
                                                </p>
                                                <h2 class="text-white">Coupon Code : <span class="tx-warning">HTMSUNSHINE</span></h2>
                                            </div>
                                            <a href="#plans" class="btn btn-secondary"><i class="fe fe-eye me-2"></i> View Plans</a>
                                            <a href="https://themeforest.net/user/spruko/portfolio" target="_blank" class="btn btn-white"><i class="fe fe-shopping-cart me-2"></i> Buy Now</a>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="banner-bg mt-5 mt-lg-0">
                                                <img src="{{asset('build/assets/images/png/61.png')}}" class="reseller-img img-fluid" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                </div>                            
                ...
                <section class="section bg-pattern-1">
                    ...
                    <img src="{{asset('build/assets/images/patterns/9.png')}}" alt="img" class="patterns-3 filter-invert sub-pattern-2 op-2">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Features</span></div>
                            <div class="heading-title">Web Hosting <span class="tx-primary">Plans</span> </div>
                            <div class="heading-description">Choose Correct Plan For Your Business</div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div class="flex-grow-1">
                                                <h4 class="mb-0">Shared Hosting</h4>
                                            </div>
                                        </div>
                                        <p class="mb-1 tx-muted">Starts at</p>
                                        <h2 class="mb-3">$8.99 <span class="tx-14 op-7 tx-muted">/ month</span></h2>
                                        <p class="mb-4">Magna dolore elitr ut et labore stet dolor tempor at ipsum, amet quis nostrum exercitationem.</p>
                                        <a href="{{url('linux-shared-hosting')}}" class="btn btn-primary">Get Started Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card pricing-card border mb-lg-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div class="flex-grow-1">
                                                <h4 class="mb-0">Multidomain Hosting</h4>
                                            </div>
                                        </div>
                                        <p class="mb-1 tx-muted">Starts at</p>
                                        <h2 class="mb-3">$18.99 <span class="tx-14 op-7 tx-muted">/ month</span></h2>
                                        <p class="mb-4">At vero eos et accusamus et iusto odio dignissimos ducimus qui quidem rerum facilis.</p>
                                        <a href="{{url('windows-shared-hosting')}}" class="btn btn-primary">Get Started Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card pricing-card border mb-lg-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div class="flex-grow-1">
                                                <h4 class="mb-0">Cloud Hosting</h4>
                                            </div>
                                        </div>
                                        <p class="mb-1 tx-muted">Starts at</p>
                                        <h2 class="mb-3">$28.99 <span class="tx-14 op-7 tx-muted">/ month</span></h2>
                                        <p class="mb-4">Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores rerum hic tenetur.</p>
                                        <a href="{{url('cloud')}}" class="btn btn-primary">Get Started Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="section overflow-hidden">
                    ...
                    <img src="{{asset('build/assets/images/patterns/7.png')}}" alt="img" class="patterns-5 left-0 transform-rotate-180 z-index-0">
                    <div class="container">
                        <div class="row">
                            <div class="heading-section">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card border feature-card-15 mb-xl-0">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="mb-0">Sed ut perspiciatis unde omnis natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam nemo enim.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-sm-6">
                ...
                <section class="banner-pd-1 blob-bg-sec">
                    ...
                    <img src="{{asset('build/assets/images/patterns/9.png')}}" alt="img" class="patterns-9 sub-pattern-1">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-6 reveal">
                                <h2 class="mb-1 text-white">Building Website Is Easy</h2>
                                <p class="mb-4 op-7 tx-15">Get Website Builder, Plugins, Themes, Icons and more.</p>
                                <p class="mb-4">
                                    Create your website instantly, no coding/design skills required. Choose from over 100 themes or simply drag-and-drop to customize your design.
                                </p>
                                <a href="#domain" class="btn btn-lg btn-secondary">Get Started</a>
                            </div>
                            <div class="col-lg-6 text-lg-end text-center mt-5 mt-lg-0">
                                <img src="{{asset('build/assets/images/png/69.png')}}" alt="img" class="build-img reveal img-fluid">
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="section bg-pattern-1 bg-gray-100" id="domain">
                    <div class="container">
                        <div class="row text-center justify-content-center">
                            <div class="heading-section">
                                <div class="heading-title">Looking For a <span class="tx-primary">Domain?</span> </div>
                                <div class="heading-description">Invidunt erat elitr ut accusam amet ipsum lorem</div>
                            </div>
                            <div class="col-xl-9">
                                <div class="card-body text-center">
                                    <img src="{{asset('build/assets/images/patterns/7.png')}}" alt="img" class="patterns-7">
                                    <img src="{{asset('build/assets/images/patterns/24.png')}}" alt="img" class="patterns-8 sub-pattern-1 op-1 z-index-1">
                                    <img src="{{asset('build/assets/images/patterns/24.png')}}" alt="img" class="patterns-3 sub-pattern-1 op-1 z-index-1">
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-lg-0">
                                    <div class="position-relative">
                                        <a href="{{url('blog-details')}}">
                                            <img class="card-img-top" src="{{asset('build/assets/images/blog/3.jpg')}}" alt="blog-image">
                                        </a>
                                        <span class="badge bg-secondary blog-badge">Hosting</span>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <h5><a href="{{url('blog-details')}}" class="tx-color-default">Starting a Web Hosting Business</a></h5>
                            ...
                            <div class="col-lg-4">
                                <div class="card mb-lg-0">
                                    <div class="position-relative">
                                        <a href="{{url('blog-details')}}">
                                            <img class="card-img-top" src="{{asset('build/assets/images/blog/6.jpg')}}" alt="blog-image">
                                        </a>
                                        <span class="badge bg-info blog-badge">Email</span>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <h5><a href="{{url('blog-details')}}" class="tx-color-default">Email Hosting For Your Projects</a></h5>
                            ...
                            <div class="col-lg-4">
                                <div class="card mb-lg-0">
                                    <div class="position-relative">
                                        <a href="{{url('blog-details')}}">
                                            <img class="card-img-top" src="{{asset('build/assets/images/blog/5.jpg')}}" alt="blog-image">
                                        </a>
...
@section('scripts')
        ...
        <!-- COUNTDOWN JS -->
        @vite('resources/assets/js/countdown.js')
