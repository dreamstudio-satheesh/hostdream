...
@section('content')
            ...
            <div class="main-content app-content">
                <section class="banner-section section banner-1 video-banner pb-0">
                    ...
                    <video src="{{asset('build/assets/images/video/video-1.mp4')}}" class="video" loop muted autoplay></video>
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-7 mb-5">
                                <div class="mb-5">
                                    <p class="mb-3 content-1 h5 text-white">Trusted Web Hosting Site For Your <span class="tx-info-dark position-relative">Website.<span class="br-bottom-before"></span></span></p>
                                    <p class="content-2">Dedicated resources, full root access & easy scaling. It is the virtual private server you've been cravin'</p>
                                </div>
                                <a href="#domain" class="btn btn-lg  btn-secondary me-2 mb-2 mb-sm-0"><i class="bi bi-arrow-right me-2"></i>Get Started</a>
                                <a href="{{url('contact-us')}}" class="btn btn-lg btn-white mb-2 mb-sm-0"><i class="bi bi-telephone me-2"></i>Contact Us</a>
                            </div>
                            <div class="col-lg-5">
                                <div class="text-lg-end text-center mt-4 mt-lg-0">
                                    <img src="{{asset('build/assets/images/png/80.png')}}" class="img-fluid op-9" width="500" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
