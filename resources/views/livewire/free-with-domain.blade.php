                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-12 text-center">
                                <div class="">
                                    <p class="mb-3 content-1 h5 text-white">Free <span class="tx-info-dark">Add-Ons</span></p>
                                    <p class="mb-0 tx-26">You will get the Free Add-Ons With Every Domain Name</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section bg-pattern-1 bg-gray-100">
                    <div class="container">
                        ...
                        <div class="row ">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 text-center mt-3">
                                                ...
                                                <p class="mb-0 op-8">Quas molestias excepturi sint occaecati cupiditate non provident placeat facere abt.</p>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 text-center mt-3">
                                                ...
                                                <p class="mb-0 op-8">Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore besmi.</p>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card reveal feature-card-15 feature-card-17 info">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 text-center mt-3">
                                            ...
                                            <div class="icon bg-gray-100">
                                                <span class="avatar bg-info-gradient rounded-circle">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card reveal feature-card-15 feature-card-17 pink">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 text-center mt-3">
