...
@section('content')
            ...
            <div class="main-content app-content">
                <section class="banner-1 banner-section banner-arrow-down">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-7">
                                <p class="mb-4 content-1 h5 text-white">Get an edge with Premium <span class="tx-info-dark">Domains!</span></p>
                                <p class="content-2 mb-4">Don't let your Business be just another .COM</p>
                            ...
                            <div class="col-lg-5">
                                <div class="text-lg-end text-center mt-lg-0 mt-5">
                                    <img src="{{asset('build/assets/images/png/16.png')}}" alt="img" class="img-fluid" width="300">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section custom-bg z-index-0 bg-gray-100">
                    ...
                    <div class="container">
                        <div class="heading-section">
                            ...
                            <div class="heading-title">Start Your Premium <span class="tx-primary">Domain Name</span> </div>
                        </div>
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-center feature-card-15">
                                    <div class="card-body">
                                        ...
                                        <div class="ribbone tx-primary"><span class="bg-danger">Premium</span></div>
                                        <p>Est amet sit vero sanctus.</p>
                                        <p class="tx-secondary mb-2">Starts at</p>
                ...
                <section class="section bg-pattern-1">
                    <img src="{{asset('build/assets/images/patterns/9.png')}}" alt="img" class="patterns-7 filter-invert z-index-1">
                    <img src="{{asset('build/assets/images/patterns/15.png')}}" alt="img" class="patterns-4 z-index-0 op-9 height-inherit">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Benefits</span></div>
                            <div class="heading-title">Why <span class="tx-primary">Premium? </span></div>
                            <div class="heading-description">Premium Domain Names are high value, popular names that have already been registered but are up for sale by the Domain owner.</div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-3 col-md-6">
                                <div class="card shadow-none bg-transparent align-items-center">
                                    <img src="{{asset('build/assets/images/icons/11.png')}}" alt="img" class="d-none d-md-block">
                                    <div class="card-body text-center custom-card-1 mt-0 mt-md-3">
                                        <p class="flex-grow-1 mb-3 h5">Get Short, Memorable Names</p>
                                        <p class="mb-0">Register a catchy name that accurately defines your business and differentiates you from the crowd.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="card shadow-none bg-transparent align-items-center">
                                    <div class="card-body text-center custom-card-2 mb-0 mb-md-3">
                                        <p class="flex-grow-1 mb-3 h5">Attract More Traffic</p>
                                        <p class="mb-0">Get well established names that boast of an excellent page rank, making it easier for your customers to find you.</p>
                                    </div>
                                    <img src="{{asset('build/assets/images/icons/14.png')}}" alt="img" class="d-none d-md-block">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="card shadow-none bg-transparent align-items-center">
                                    <img src="{{asset('build/assets/images/icons/12.png')}}" alt="img" class="d-none d-md-block">
                                    <div class="card-body text-center custom-card-1 mt-0 mt-md-3">
                                        <p class="flex-grow-1 mb-3 h5">Get Great SEO Potential</p>
                                        <p class="mb-0">You Can Invite type-in traffic with keyword-rich Premium Domains and boost your SEO ranking.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="card shadow-none bg-transparent align-items-center">
                                    <div class="card-body text-center custom-card-2 mb-0 mb-md-3">
                                        <p class="flex-grow-1 mb-3 h5">Get Better Branding</p>
                                        <p class="mb-0">You Can Invite type-in traffic with keyword-rich Premium Domains and boost your SEO ranking.</p>
                                    </div>
                                    <img src="{{asset('build/assets/images/icons/10.png')}}" alt="img" class="d-none d-md-block">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card feature-card-15">
                                    <div class="card-body">
                                        ...
                                        <p>Takimata kasd kasd amet consetetur tempor clita at amet, tempor Est amet sit vero sanctus.</p>
