...
@section('content')
            ...
            <div class="main-content app-content">
                                ...
                                <div class="col-lg-7">
                                    <div class="mb-4">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li class="list-item"><i class="fe fe-chevron-right bg-white-2 rounded-circle p-1 me-2"></i>Money Back Guarantee</li>
                                        </ul>
                                    </div>
                                    <a href="#plans" class="btn btn-lg btn-secondary me-2"><i class="fe fe-eye me-2"></i> View Plans</a>
                                    <a href="https://themeforest.net/user/spruko/portfolio" class="btn btn-lg btn-white"><i class="fe fe-shopping-cart me-2"></i> Buynow</a>
                                </div>
                                <div class="col-lg-5">
                ...
                <section class="section">
                    <img src="{{asset('build/assets/images/patterns/2.png')}}" alt="img" class="patterns-1 op-1 z-index-0">
                    <img src="{{asset('build/assets/images/patterns/26.png')}}" alt="img" class="patterns-7 op-2 z-index-0">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Features</span></div>
                            <div class="heading-title">What You'll Get With <span class="tx-primary">This Hosting</span> </div>
                            <div class="heading-description">Main Features</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card border feature-card-16 shadow-none">
                                    <div class="card-body">
                                        <div class="p-2 rounded-circle bg-primary-transparent d-inline-block mb-4">
                                            <span class="avatar avatar-lg feature-avatar all-ease-03 rounded-circle bg-primary-gradient text-white tx-24">
                                                <i class="bi bi-menu-app outline"></i>
                                                <i class="bi bi-menu-app-fill filled"></i>
                                            </span>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card border feature-card-16 shadow-none">
                                    <div class="card-body">
                                        <div class="p-2 rounded-circle bg-secondary-transparent d-inline-block mb-4">
                                            <span class="avatar avatar-lg feature-avatar all-ease-03 rounded-circle bg-secondary-gradient text-white tx-24">
                                                <i class="bi bi-envelope-paper outline"></i>
                                                <i class="bi bi-envelope-paper-fill filled"></i>
                                            </span>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card border feature-card-16 shadow-none">
                                    <div class="card-body">
                                        <div class="p-2 rounded-circle bg-success-transparent d-inline-block mb-4">
                                            <span class="avatar avatar-lg feature-avatar all-ease-03 rounded-circle bg-success-gradient text-white tx-24">
                                                <i class="bi bi-file-text outline"></i>
                                                <i class="bi bi-file-text-fill filled"></i>
                                            </span>
                                        </div>
                ...
                <section class="section bg-gray-100">
                    ...
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Plugins</span></div>
                            <div class="heading-title">Power Packed Product With <span class="tx-primary">These Tools</span> </div>
                            <div class="heading-description">50+ Plugins Available</div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/7.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/19.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/8.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/20.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/9.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/21.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/10.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/22.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/11.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/23.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/12.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/24.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/13.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/25.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/14.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/26.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                <div class="card feature-card-15 text-center align-items-center">
                                    <div class="card-body">
                                        <img src="{{asset('build/assets/images/png/apps/15.png')}}" alt="img" width="150" class="tool-img img-fluid">
                                        <img src="{{asset('build/assets/images/png/apps/27.png')}}" alt="img" width="150" class="tool-img-white img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="section bg-pattern-2 bg-image1">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-title text-white">Why Choose Us </div>
                            <div class="heading-description text-white op-8">Checkout Our Features</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card feature-card-2 reveal">
                ...
                <section class="section bg-pattern-1 bg-image5">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Speed</span></div>
                            <div class="heading-title">This Is What You Need To Know <span class="tx-primary">Loading Speed</span> </div>
                            <div class="heading-description">Experience The Speeds</div>
                        </div>
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6">
                                <p class="h3 mb-4">Lightning Fast Loading</p>
                                <p class="mb-4">Our web application accelerator, powered by Varnish Cache, ensures the maximum performance of your website at all times!</p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <span class="badge bg-primary mb-2">Tools</span>
                                                <h5>Power Packed Tools</h5>
                                                <p class="mb-0">Est et diam rebum accusam labore, sanctus et diam.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <span class="badge bg-secondary mb-2">SSD</span>
                                                <h5>Solid State Drivers (SSD)</h5>
                                                <p class="mb-0">Est et diam rebum accusam labore, sanctus et diam.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <span class="badge bg-success mb-2">Server</span>
                                                <h5>Light Speed Web Server</h5>
                                                <p class="mb-0">Est et diam rebum accusam labore, sanctus et diam.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <span class="badge bg-danger mb-2">Space</span>
                                                <h5>Ultimate Web Space</h5>
                                                <p class="mb-0">Est et diam rebum accusam labore, sanctus et diam.</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-5 text-center text-lg-start">
                                <img src="{{asset('build/assets/images/png/22.png')}}" class="img-fluid" alt="img">
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="section bg-gray-100" id="plans">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card pricing-card shadow border-top border-5 border-primary">
                                    <div class="card-body">
                ...
                <section class="section bg-pattern-1 bg-image3">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Installation</span></div>
                            <div class="heading-title">Wordpress Installation of <span class="tx-primary">Your Website</span> </div>
                            <div class="heading-description">1-Click Installtion</div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-lg-6 text-center">
                                <img src="{{asset('build/assets/images/png/14.png')}}" class="img-fluid" alt="img">
                            </div>
                            <div class="col-lg-6">
                                <p class="h3">Single Click Installation</p>
                                <p class="mb-4">Install a Shopping Cart, Photo Gallery, a Blog or any other module in just 1 click.</p>
                                <ul class="list-unstyled fw-500 mb-4">
                                    <li class="list-item mb-2">
                                        <div class="d-flex align-items-start">
                                            <span class="me-2 tx-primary"><i class="bi bi-check-circle-fill"></i></span>
                                            <span class="flex-grow-1">50+ Plugins</span>
                                        </div>
                                    </li>
                                    <li class="list-item mb-2">
                                        <div class="d-flex align-items-start">
                                            <span class="me-2 tx-primary"><i class="bi bi-check-circle-fill"></i></span>
                                            <span class="flex-grow-1">Solid State Drivers (SSD)</span>
                                        </div>
                                    </li>
                                    <li class="list-item mb-2">
                                        <div class="d-flex align-items-start">
                                            <span class="me-2 tx-primary"><i class="bi bi-check-circle-fill"></i></span>
                                            <span class="flex-grow-1">Light Speed Web Server</span>
                                        </div>
                                    </li>
                                    <li class="list-item">
                                        <div class="d-flex align-items-start">
                                            <span class="me-2 tx-primary"><i class="bi bi-check-circle-fill"></i></span>
                                            <span class="flex-grow-1">Ultimate Web Space</span>
                                        </div>
                                    </li>
                                </ul>
                                <a href="javascript:void(0);" class="btn btn-primary btn-lg">Get Started</a>
                            </div>
                        </div>
                    </div>
                </section>

                <section class="section bg-pattern-1 bg-image2 bg-gray-100">
                    <img src="{{asset('build/assets/images/patterns/9.png')}}" alt="img" class="patterns-3 filter-invert op-1 z-index-0">
                    <img src="{{asset('build/assets/images/patterns/15.png')}}" alt="img" class="patterns-2 op-1 z-index-0">
                    <div class="container">
                        <div class="heading-section">
                            <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">Features</span></div>
                            <div class="heading-title">Under The <span class="tx-primary">Hood</span> </div>
                            <div class="heading-description">Key Features</div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <div class="feature-card-5 feature-card-5-primary hover position-relative">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center mb-5 bg-gray-100 br-5">
                                                <img src="{{asset('build/assets/images/png/17.png')}}" class="img-fluid" alt="img" width="220">
                                            </div>
                                            <h4 class="mb-4">State of the Art Servers</h4>
                                            <ul class="list-unstyled tx-14 mb-0">
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Dual Intel Xeon Processor E5-2630</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">64 GB RAM</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">256 GB SSD In RAID 1</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Octa Core With 2.40 GHz</span>
                                                    </div>
                                                </li>
                                                <li class="list-item">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">2 TB SATA In RAID 1</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="feature-card-5 feature-card-5-primary hover position-relative">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center mb-5 bg-gray-100 br-5">
                                                <img src="{{asset('build/assets/images/png/19.png')}}" class="img-fluid" alt="img" width="220">
                                            </div>
                                            <h4 class="mb-4">Top-Notch Security</h4>
                                            <ul class="list-unstyled tx-14 mb-0">
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Anti Spam & Virus Protection</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Password Protect Directories</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Secure FTP Access</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">IP Blocking</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">phpMyAdmin Access</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Hotlink & Leech Protection</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Cron Jobs for Scheduled Tasks</span>
                                                    </div>
                                                </li>
                                                <li class="list-item">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Website Statistics With AWstats</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="feature-card-5 feature-card-5-primary hover position-relative">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center mb-5 bg-gray-100 br-5">
                                                <img src="{{asset('build/assets/images/png/18.png')}}" class="img-fluid" alt="img" width="220">
                                            </div>
                                            <h4 class="mb-4">Program In Any Language</h4>
                                            <ul class="list-unstyled tx-14 mb-0">
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">PHP 7.3/7.4, Perl, Python, RoR, GD, cURL, CGI, mcrypt</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Apache 2.4x</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">MySQL 5</span>
                                                    </div>
                                                </li>
                                                <li class="list-item mb-2">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Ruby On Rails</span>
                                                    </div>
                                                </li>
                                                <li class="list-item">
                                                    <div class="d-flex align-items-start">
                                                        <span class="me-2 tx-primary"><i class="bi bi-check-circle"></i></span>
                                                        <span class="fw-600">Zend Optimizer & Engine, IonCube-Loader</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <!-- OFFER MODAL -->
            <div class="modal fade show offer-modal" id="offerModal" tabindex="-1" aria-labelledby="offerModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body text-center text-white" id="offerModalLabel">
                            <a href="javascript:void(0);" class="btn-close text-white modalCookie" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x"></i></a>
                            <img src="{{asset('build/assets/images/png/36.png')}}" alt="img" width="280" class="img-fluid">
                            <h1 class="text-white text-shadow">Big Sale - 55% OFF </h1>
                            <h4 class="mt-3 text-white">Coupon Code :  <span class="tx-warning-light">HOST55</span></h4>
                            <div class="row justify-content-center align-items-center my-5">
                                <div class="col-lg-12 text-center">
                                    <div class="d-sm-flex justify-content-center">
                                        <div class="counter-item offer-counter">
                                            <h5 class="count_down">0</h5>
                                            <h6 class="mb-0 text-white fw-normal">Days</h6>
                                        </div>
                                        <div class="counter-item offer-counter">
                                            <h5 class="count_down">0</h5>
                                            <h6 class="mb-0 text-white fw-normal">Hours</h6>
                                        </div>
                                        <div class="counter-item offer-counter">
                                            <h5 class="count_down">0</h5>
                                            <h6 class="mb-0 text-white fw-normal">Mins</h6>
                                        </div>
                                        <div class="counter-item offer-counter">
                                            <h5 class="count_down">0</h5>
                                            <h6 class="mb-0 text-white fw-normal">Secs</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="btn-wrap pb-4 mb-1">
                                <a href="{{url('linux-reseller-hosting')}}" target="_blank" class="btn btn-secondary min-w-fit-content mb-2 mb-sm-0 me-1">Grab It Now <span class="tx-18 fw-bold">55% Discount</span></a>
                                <a href="javascript:void(0);" data-bs-dismiss="modal" class="btn btn-outline-light lh-lg min-w-fit-content mb-2 mb-sm-0 modalCookie">Remember me Later</a>
                            </div>
                        </div>
                    </div>
                </div>
