            ...
            <footer class="footer bg-primary mt-auto text-white position-relative">
                <img src="{{asset('build/assets/images/patterns/9.png')}}" alt="img" class="patterns-9 z-index-0">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                                <a href="{{url('index')}}" class="d-inline-block mb-3"><img src="{{asset('build/assets/images/brand/logo-white.png')}}" alt="img"></a>
                                <p class="mb-4 op-8 fw-light">
                                    We provide cloud based enterprise hosting, 
                                    server and storage solutions of unmatched quality. 
                                    Feel free to visit or contact us for a custom quote.
                                </p>
                                <ul class="list-unstyled mb-0">
                                    <li class="list-item mb-2"><a href="{{url('register-domain')}}" class="footer-link"><i class="bi bi-telephone me-3 tx-18"></i>+91 6379108040</a></li>
                                    <li class="list-item mb-2"><a href="{{url('register-domain')}}" class="footer-link"><i class="bi bi-envelope-plus me-3 tx-18"></i>info@dreamhost.in</a></li>
                                    <li class="list-item"><a href="{{url('register-domain')}}" class="footer-link"><i class="bi bi-geo-alt me-3 tx-18"></i>Coimbatore, TN </a></li>
                                </ul>
                            ...
                            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                                ...
                                <ul class="list-unstyled footer-icon">
                                    <li class="list-item mb-2"><a href="{{url('register-domain')}}" class="footer-link">Register Domain Name</a></li>
                                    <li class="list-item mb-2"><a href="{{url('register-domain')}}" class="footer-link">View Domain Pricing</a></li>
                                    <li class="list-item mb-2"><a href="{{url('premium-domains')}}" class="footer-link">Premium Domains</a></li>
                                    <li class="list-item mb-2"><a href="{{url('domain-transfer')}}" class="footer-link">Transfer Your Domain</a></li>
                                    <li class="list-item mb-2"><a href="{{url('domain-transfer')}}" class="footer-link">Bulk Domain Transfer</a></li>
                                    <li class="list-item mb-2"><a href="{{url('free-with-domain')}}" class="footer-link">Free With Every Domain</a></li>
                                    <li class="list-item mb-2"><a href="{{url('name-suggestion-tool')}}" class="footer-link">Name Suggestion</a></li>
                                    <li class="list-item mb-2"><a href="{{url('whois-lookup')}}" class="footer-link">Whois Lookup</a></li>
                                    <li class="list-item"><a href="{{url('premium-domains')}}" class="footer-link">View Promos</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                                <h4 class="text-white">Hosting & Products</h4>
                                <ul class="list-unstyled footer-icon">
                                    <li class="list-item mb-2"><a href="{{url('linux-shared-hosting')}}" class="footer-link">Linux Hosting</a></li>
                                    <li class="list-item mb-2"><a href="{{url('windows-shared-hosting')}}" class="footer-link">Windows Hosting</a></li>
                                    <li class="list-item mb-2"><a href="{{url('wordpress-shared-hosting')}}" class="footer-link">WordPress Hosting</a></li>
                                    <li class="list-item mb-2"><a href="{{url('dedicated-server')}}" class="footer-link">Dedicated Servers</a></li>
                                    <li class="list-item mb-2"><a href="{{url('linux-reseller-hosting')}}" class="footer-link">Reseller Hosting</a></li>
                                    <li class="list-item mb-2"><a href="{{url('cloud')}}" class="footer-link">Cloud Hosting</a></li>
                                    <li class="list-item mb-2"><a href="{{url('ssl-certificates')}}" class="footer-link">SSL Certificates</a></li>
                                    <li class="list-item mb-2"><a href="{{url('sitelock')}}" class="footer-link">SiteLock</a></li>
                                    <li class="list-item"><a href="{{url('codeguard-backup')}}" class="footer-link">Codeguard</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
                                ...
                                <ul class="list-unstyled footer-icon">
                                    <li class="list-item mb-2"><a href="{{url('blog')}}" class="footer-link">Our Blog</a></li>
                                    <li class="list-item mb-2"><a href="{{url('contact-us')}}" class="footer-link">Contact Support</a></li>
                                    <li class="list-item mb-2"><a href="{{url('contact-us')}}" class="footer-link">Report Abuse</a></li>
                                    <li class="list-item mb-2"><a href="{{url('login')}}" class="footer-link">Affiliate</a></li>
                                    <li class="list-item mb-2"><a href="{{url('cancellation-refund')}}" class="footer-link">Cancellation & Refund Policy</a></li>
                                    <li class="list-item"><a href="{{url('payment-options')}}" class="footer-link">Payment Options</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-7">
                                <div class="d-md-flex align-items-center">
                                    ...
                                    <div class="mt-3 mt-md-0">
                                        ...
                                        <a href="{{url('payment-options')}}" class="text-white"><i class="far fa-plus me-1"></i>And more</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <ul class="list-unstyled d-sm-flex mb-0 justify-content-lg-end mt-3 mt-lg-0 ">
                                    <li class="list-item"><a href="{{url('terms-of-service')}}" class="footer-link px-3 border-end border-white-2 op-8">Terms of Service</a></li>
                                    <li class="list-item"><a href="{{url('privacy-policy')}}" class="footer-link px-3 border-end border-white-2 op-8">Privacy Policy</a></li>
                                    <li class="list-item"><a href="{{url('legal')}}" class="footer-link px-3 op-8">Legal</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="py-3 border-top border-white-2 text-center">
                    <div class="container">
                        <span class="tx-14 op-8">
                            Copyright &#169;
                            <span id="year"></span>
                            <a href="{{url('index')}}" class="text-white">DreamHost.</a>
                            Designed with
                            <span class="fa fa-heart tx-danger"></span>
                            by
                            <a href="javascript:void(0);" class="text-white">dreamhost.in</a>
                            All Rights Reserved
                        </span>
                    </div>
                </div>
